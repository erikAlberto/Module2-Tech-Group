...
public class DoublyCircularLinkedListTest {
    ...
    public void testAddMethodShouldIncreaseTheSizeOfTheList() {
        DoublyCircularLinkedList<String> doubleLinkedList = new DoublyCircularLinkedList<>();

        doubleLinkedList.add("sdsdf");
        doubleLinkedList.add("dsdf");
        doubleLinkedList.add("hello");
...
//        DoublyCircularLinkedList<String> doubleLinkedList = new DoublyCircularLinkedList<>();
//
//        doubleLinkedList.add("world");
//        doubleLinkedList.add("hello");
//        doubleLinkedList.add("gat");
//        assertEquals("[world, hello, gat]", doubleLinkedList.toString());
//    }
//
    @Test
    public void testGetMethodShouldReturnTheValueOfTheNodeOnTheSpecifiedIndex() {
        ...
        doubleLinkedList.add("world");
        doubleLinkedList.add("people");
        doubleLinkedList.add("hello");

        assertEquals("world", doubleLinkedList.get(0));
        assertEquals("people", doubleLinkedList.get(1));
        assertEquals("hello", doubleLinkedList.get(2));
    }
